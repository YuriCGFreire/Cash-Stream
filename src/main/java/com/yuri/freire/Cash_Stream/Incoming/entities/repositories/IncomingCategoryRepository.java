...
public interface IncomingCategoryRepository extends JpaRepository<IncomingCategory, Integer> {
    ...
    @Query("""
            ...
            """)
    Optional<IncomingCategory> findByCategoryId(@Param("incomingCategoryId") Integer incomingCategoryId, @Param("username") String username);
    ...
    @Query("""
            ...
            AND ic.user.username = :username
            """)
    Optional<IncomingCategory> findByCategoryName(@Param("categoryName") String incomingCategory, @Param("username") String username);
    ...
    @Query("""
            ...
            AND ic.user.username = :username
            """)
    Page<IncomingCategoryResponse> findAllIncomingCategory(Pageable pageable, @Param("username") String username );
}
