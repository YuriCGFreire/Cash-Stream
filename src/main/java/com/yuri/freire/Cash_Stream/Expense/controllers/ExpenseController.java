...
public class ExpenseController {
    ...
    public ResponseEntity<ApiResponse<ExpenseResponse>> createExpense(
        ...
        ExpenseResponse expense = expenseService.createExpense(expenseRequest, userDetails.getUsername());
    ...
    @GetMapping("/find-all")
    public ResponseEntity<ApiResponse<Page<ExpenseResponse>>> findAllExpenses(
            Pageable pageable, HttpServletRequest request,
            @AuthenticationPrincipal UserDetails userDetails){
        Page<ExpenseResponse> allExpenses = expenseService.findAllExpenses(pageable, userDetails.getUsername());
    ...
    public ResponseEntity<ApiResponse<Page<ExpenseResponse>>> findAllExpensesByCategoryName(
            @RequestParam String categoryName,
            Pageable pageable,
            HttpServletRequest request,
            @AuthenticationPrincipal UserDetails userDetails){
        Page<ExpenseResponse> allExpensesByCategory = expenseService.findAllExpensesByCategoryName(categoryName, pageable, userDetails.getUsername());
    ...
    public ResponseEntity<ApiResponse<Page<ExpenseResponse>>> findAllExpensesBySubcategoryName(
            @RequestParam String subcategoryName,
            Pageable pageable,
            HttpServletRequest request,
            @AuthenticationPrincipal UserDetails userDetails){
        Page<ExpenseResponse> allExpensesByCategory = expenseService.findAllBySubcategoryName(subcategoryName, pageable, userDetails.getUsername());
    ...
    public ResponseEntity<ApiResponse<Page<ExpenseResponse>>> findAllExpensesByPaymentMethod(
            @RequestParam ExpenseMethodType expenseMethodType,
            Pageable pageable,
            HttpServletRequest request,
            @AuthenticationPrincipal UserDetails userDetails){
        Page<ExpenseResponse> allExpensesByCategory = expenseService.findAllExpensesByPaymentMethod(expenseMethodType, pageable, userDetails.getUsername());
    ...
    public ResponseEntity<ApiResponse<Page<ExpenseResponse>>> findAllByIsEssential(
            @RequestParam boolean isEssential,
            Pageable pageable,
            HttpServletRequest request,
            @AuthenticationPrincipal UserDetails userDetails){
        Page<ExpenseResponse> findByIsEssential = expenseService.findAllExpensesByIsEssential(isEssential, pageable, userDetails.getUsername());
    ...
    public ResponseEntity<ApiResponse<String>> softDeleteExpense(
            @PathVariable Integer expenseId,
            HttpServletRequest request,
            @AuthenticationPrincipal UserDetails userDetails){
        String softDeleteExpense = expenseService.softDeleteExpense(expenseId, userDetails.getUsername());
