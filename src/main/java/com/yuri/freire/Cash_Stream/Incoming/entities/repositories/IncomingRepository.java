...
public interface IncomingRepository extends JpaRepository<Incoming, Integer> {
    ...
    @Query("""
            ...
            """)
    Optional<Incoming> findIncomingById(@Param("incomingId") Integer incomingId, @Param("username") String username);
    ...
    @Query("""
            ...
            AND i.user.username = :username
            """)
    Page<IncomingResponse> findAllIncomings(Pageable pageable, @Param("username") String username);
    ...
    @Query("""
            ...
            AND i.user.username = :username
            """)
    Page<IncomingResponse> findAllByCategory(@Param("categoryName") String categoryName, Pageable pageable, @Param("username") String username);
    ...
    @Query("""
            ...
            AND i.user.username = :username
            """)
    Page<IncomingResponse> findAllBySubcategory(@Param("subCategoryName") String subcategoryName, Pageable pageable, @Param("username") String username);
}